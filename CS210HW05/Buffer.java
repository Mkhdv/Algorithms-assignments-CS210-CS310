...
public class Buffer {
    ...
    public void left(int k) {
        while(!left.isEmpty() && --k >= 0) right.push(left.pop());
    }

    // Move the cursor k positions to the right.
    public void right(int k) {
        while(!right.isEmpty() && --k >= 0) left.push(right.pop());
    }
    ...
    // Helper function to get appropriate output
    private String format(Stack<Character> b) {
